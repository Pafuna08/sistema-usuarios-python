...
4. Mostrar la configuración de la aplicación.
5. Salir del sistema.
...
Manejar excepciones.
Coordinar los diferentes módulos del proyecto.
...
Nombre de la aplicación: Sistema Usuarios
Versión: 1.0
...
Evitar concentrar todo el código en un único archivo.
